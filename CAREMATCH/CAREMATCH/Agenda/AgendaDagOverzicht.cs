    ...
    class AgendaDagOverzicht
    {
        ...
        public void DrawAgendaPunten(Graphics g)
        {
            ...
            foreach (AgendaPunt ap in gebruiker.GetAgendaPunten())
            {
                ...
                y = (xSpace * (ap.DatumTijdStart - 8));
                g.FillRectangle(sd, new Rectangle(aantalAfspraken * 200 + 50, Convert.ToInt32(y), 180, ap.DatumTijdStart * ap.DatumTijdEind));
